...
const validateHostname = (cookieHostname: any, requestHostname: any, subdomains: any) => {
...
const validatePath = (cookiePath: any, requestPath: any) => {
...
const splitN = (str: any, sep: any, n: any) => {
...
export default class Cookie {
    ...
    expiry: any;
    domain: any;
    subdomains: boolean | undefined;
    secure: boolean | undefined;
    path: any;
    constructor(str: any, requestURL: any) {
    ...
    hasExpired(sessionEnded: boolean) {
        return (
            (sessionEnded && this.expiry === null) ||
            (this.expiry && this.expiry < new Date())
        );
    }
    isValidForRequest(requestURL: string) {
